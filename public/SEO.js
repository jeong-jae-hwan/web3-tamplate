...
function SEO({ title, description, image }) {
  return (
    <NextSeo
      ...
      description={
        description ? description : "Next.js 템플릿에 오신 것을 환영합니다"
      } // 50~160자 이하
      canonical="https://web3-tamplate.vercel.app/"
      openGraph={{
        type: "website",
        locale: "ko_KR",
        url: "https://web3-tamplate.vercel.app/",
        title: title
          ? `${title} | Next.js 템플릿에 오신 것을 환영합니다`
          : "Next.js 템플릿에 오신 것을 환영합니다",
      ...
      twitter={{
        ...
        handle: "@사이트명",
        site: "https://web3-tamplate.vercel.app/",
      }}
    />
  );
}
